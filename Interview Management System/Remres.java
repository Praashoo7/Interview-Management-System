...
public class Remres extends JFrame implements ActionListener
{
	JLabel l1;
	JTextField tf1;
	JButton btn1;
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==btn1)
		{
			...
			String query="delete from addres where resno=?";
			try 
			{
				...
				if(y>0)
				{
	                        ...
	                        JOptionPane.showMessageDialog(btn1,"Deleted Succesfully","Remove Result",JOptionPane.PLAIN_MESSAGE);
				}
				else
				{
								UIManager.put("OptionPane.messageFont",new Font("Caviar Dreams", Font.PLAIN, 15));
						JOptionPane.showMessageDialog(btn1,"Result record not Found","Remove Result",JOptionPane.PLAIN_MESSAGE);
				}
			}
			...
			{
							UIManager.put("OptionPane.messageFont",new Font("Caviar Dreams", Font.PLAIN, 15));
	                        JOptionPane.showMessageDialog(btn1,"Enter a Valid no","Remove Result",JOptionPane.PLAIN_MESSAGE);
