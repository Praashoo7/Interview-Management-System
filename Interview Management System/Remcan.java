...
public class Remcan extends JFrame implements ActionListener
{
	JLabel l1;
	JTextField tf1;
	JButton btn1;
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==btn1)
		{
			...
			String query="delete from addcan where canno=?";
			try 
			{
				...
				if(y>0)
				{
	                        ...
	                        JOptionPane.showMessageDialog(btn1,"Deleted Succesfully","Student",JOptionPane.PLAIN_MESSAGE);
				}
				else
				{
								UIManager.put("OptionPane.messageFont",new Font("Caviar Dreams", Font.PLAIN, 15));
						JOptionPane.showMessageDialog(btn1,"Candidate Record not Found","Candidate",JOptionPane.PLAIN_MESSAGE);
				}
			}
			...
			{
							UIManager.put("OptionPane.messageFont",new Font("Caviar Dreams", Font.PLAIN, 15));
	                        JOptionPane.showMessageDialog(btn1,"Enter Candidate ID","Candidate",JOptionPane.PLAIN_MESSAGE);
